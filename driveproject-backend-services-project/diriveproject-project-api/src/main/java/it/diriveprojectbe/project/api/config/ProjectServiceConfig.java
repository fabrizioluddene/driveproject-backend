package it.diriveprojectbe.project.api.config;
...
@Configuration
@EnableSwagger2
@EntityScan("it.diriveprojectbe.domain")
public class ProjectServiceConfig {

    @Bean
    public Docket eDesignApi(it.diriveprojectbe.project.api.config.SwaggerConfigProperties swaggerConfigProperties) {
    ...
    @Bean
    UiConfiguration uiConfig(it.diriveprojectbe.project.api.config.SwaggerConfigProperties swaggerConfigProperties) {
    ...
    private ApiInfo apiInfo(it.diriveprojectbe.project.api.config.SwaggerConfigProperties swaggerConfigProperties) {
